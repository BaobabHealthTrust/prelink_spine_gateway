class Spine::PatientIdentifier < ActiveRecord::Base
  ...
  belongs_to :type, :class_name => "Spine::PatientIdentifierType", :foreign_key => :identifier_type
  belongs_to :patient, :class_name => "Spine::Patient", :foreign_key => :patient_id

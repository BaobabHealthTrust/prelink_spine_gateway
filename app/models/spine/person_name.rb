class Spine::PersonName < ActiveRecord::Base
  self.establish_connection :spine
  set_table_name "person_name"
  set_primary_key "person_name_id"
  include Spine::Openmrs

  belongs_to :person, :class_name => 'Spine::Person', :foreign_key => :person_id
  # has_one :person_name_code, :class_name => 'Spine::PersonNameCode', :foreign_key => :person_name_id
